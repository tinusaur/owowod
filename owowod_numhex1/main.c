...
int main(void) {
	...
	for (;;) { // The infinite main loop
		...
		owowod_print_string("C="); owowod_print_numhexupz(234); owowod_print_string("\r\n");
		owowod_print_string("D="); owowod_print_numhexupz(-56); owowod_print_string("\r\n");

		owowod_print_string("E="); owowod_print_numhexuwpz(1234); owowod_print_string("\r\n");
		owowod_print_string("G="); owowod_print_numhexuwpz(56789); owowod_print_string("\r\n");
		owowod_print_string("H="); owowod_print_numhexuwpz(-12345); owowod_print_string("\r\n");
